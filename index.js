...
module.exports = function easyMarks(dispatch) {
    ...
    const msg = new (require('./lib/message.js'))(dispatch, 'easyMarks', '#3f7efc')
    const ploc = new (require('./lib/playerLocation.js'))(dispatch)
    const chat = new (require('./lib/chatCommands.js'))(dispatch)
    const inv = new (require('./lib/inventory.js'))(dispatch)
    const item = new (require('./lib/useItem.js'))(dispatch, ploc)
